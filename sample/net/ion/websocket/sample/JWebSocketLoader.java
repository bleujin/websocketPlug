...
import net.ion.websocket.common.api.WebSocketInitializer;
import net.ion.websocket.common.config.JWebSocketConfig;
import net.ion.websocket.common.config.xml.JWebSocketConfigHandler;
 ...
 * 
 * @author puran
 * @version $Id: JWebSocketLoader.java,v 1.1 2011/07/23 04:35:53 bleujin Exp $
 */
public final class JWebSocketLoader {
	...
	public final WebSocketInitializer initialize() throws WebSocketException {
		...
		if (lConfigPath == null) {
			throw new WebSocketException("Either JWEBSOCKET_HOME variable is not set" + " or jWebSocket.xml file does neither exist at %JWEBSOCKET_HOME%/conf" + " nor at %CLASSPATH%/conf.");
		}
	...
	private WebSocketInitializer instantiateInitializer(String aInitializerClass) {
		...
		try {
			...
			// TODO: handle exceptions properly, logging not yet initialized
			// here!
