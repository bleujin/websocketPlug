...
public class User {
	 ...
	 * the password fail counter is resetted.
	 * 
	 * @param aPassword
	 * @return
	 */
	 ...
	 * 
	 * @param aOldPW
	 *            original password or null of password is set first time.
	 * @param aNewPW
	 *            new password, nust not be <tt>null</tt>.
	...
	public boolean changePassword(String aOldPW, String aNewPW) {
		if (aOldPW != null && aNewPW != null && password.equals(aOldPW)) {
			password = aNewPW;
			return true;
		}
		return false;
	...
	// TODO: potential security hole: don't allow to change roles w/o a special
	// permission!
	/**
	...
	// TODO: potential security hole: don't allow to e.g. unlock a user w/o a
	// special permission!
	/**
	...
	// TODO: potential security hole: don't allow to reset password fail counter
	// w/o a special permission!
	/**
	...
	// TODO: potential security hole: don't allow to roll over password fail
	// counter!
	/**
	...
	// TODO: potential security hole: don't allow to unlock account w/o a
	// special permission!
	/**
