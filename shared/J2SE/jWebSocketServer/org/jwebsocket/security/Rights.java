...
public class Rights {
	...
	/**
	 * removes a certain right indentified by its key from the FastMap of
	 * rights. If the key is <tt>null</tt> or right could not be found in the
	 * FastMap no operation is performed.
	 * 
	 * @param aKey
	 */
