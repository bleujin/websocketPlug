...
public class RPCPlugIn extends TokenPlugIn {
	...
	// TODO: We need simple unique IDs to address a certain target, session id
	// not suitable here.
	...
	public static Class loadClass(String aClassName) {
		// return loadClass(aClassName, "file:/" +
		// JWebSocketServerConstants.CLASS_OUT_PATH);
		return null;
	}
	 ...
	 */
	public static Object call(Object aInstance, String aName, Object aArgs) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
		Object lObj = null;
	...
	/*
	 * public static Object call(Object aInstance, String aName, Object...
	 * aArgs) { Object lObj = null; try { Class lClass = aInstance.getClass();
	 * Method lMethod = lClass.getMethod(aName, new Class[]{Object.class});
	 * Object lArg = aArgs; lObj = lMethod.invoke(aInstance, lArg); } catch
	 * (NoSuchMethodException ex) {
	 * log.debug("No such method exception calling '" + aName + "' for class " +
	 * aInstance.getClass().getName() + ": " + ex.getMessage()); } catch
	 * (Exception ex) { log.debug("Exception calling '" + aName + "' for class "
	 * + aInstance.getClass().getName() + ": " + ex.getMessage()); } return
	 * lObj; }
	 */
}
