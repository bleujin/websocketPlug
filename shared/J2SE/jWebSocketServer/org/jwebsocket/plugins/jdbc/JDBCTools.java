...
public class JDBCTools {
	...
	public static String getJSONType(String aJavaType, ResultSetMetaData aMetaData) {
		...
		if (lResStr != null) {
			if (lResStr.equals("bigdecimal") || lResStr.equals("long") || lResStr.equals("int") || lResStr.equals("byte") || lResStr.equals("short") || lResStr.equals("float") || lResStr.equals("double")) {
				lResStr = "number";
			}
		}
		return lResStr;
