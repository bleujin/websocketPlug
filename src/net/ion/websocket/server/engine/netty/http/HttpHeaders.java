 ...
 * @version $Rev: 2312 $, $Date: 2011/06/30 04:53:52 $
 * 
 * @apiviz.landmark
...
public class HttpHeaders {
	 ...
	 * @author <a href="http://www.jboss.org/netty/">The Netty Project</a>
	 * @author Andy Taylor (andy.taylor@jboss.org)
	 * @version $Rev: 2312 $, $Date: 2010-06-23 05:35:00 +0200 (Wed, 23 Jun
	 *          2010) $
	 * 
	 * @apiviz.stereotype static
	 */
	 ...
	 * thus 'kept alive'. This methods respects the value of the {@code
	 ...
	 * retrieved from {@link HttpMessage#getContent()} but from the {@code
	 * "Content-Length"} header, and thus they are independent from each other.
	 * 
	...
	public static long getContentLength(HttpMessage message, long defaultValue) {
		...
		if (message instanceof HttpRequest) {
			...
			if (res.getStatus().getCode() == 101 && res.containsHeader(Names.SEC_WEBSOCKET_ORIGIN) && res.containsHeader(Names.SEC_WEBSOCKET_LOCATION)) {
				return 16;
			}
		}
