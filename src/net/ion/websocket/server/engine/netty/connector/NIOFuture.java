...
/**
 * NIO implementation of {@code IOFuture} to support asynchronous I/O operation for the NIO based connector.
 * 
 * @author puran
 * @version $Id: NIOFuture.java,v 1.1 2011/12/15 06:30:24 bleujin Exp $
 */
public class NIOFuture implements IOFuture {
	 ...
	 * 
	 * @param theConnector
	 *            the connector with which this future is associated
	 * @param nettyFuture
	 *            the internal netty future object that does the most of the work
	 */
