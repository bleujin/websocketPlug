...
import net.ion.websocket.server.engine.SslContextFactory;
import net.ion.websocket.server.engine.netty.NettyEngine;
import net.ion.websocket.server.engine.netty.NettyEngineHandler;
import net.ion.websocket.server.engine.netty.http.HttpRequestDecoder;
 ...
 * 
 * @author Puran Singh
 * @version $Id: NettyEnginePipeLineFactory.java 613 2010-07-01 07:13:29Z
...
public class NettyEnginePipeLineFactory implements ChannelPipelineFactory {
	...
	public ChannelPipeline getPipeline() throws Exception {
		...
		// create a new handler instance for each new channel to avoid a race condition where a unauthenticated client can get the confidential information:
