...
public class TokenFactory {
	...
	public static Token packetToToken(String aFormat, WebSocketPacket aDataPacket) {
		Token lToken = null;
		if (CommonConstants.WS_FORMAT_JSON.equals(aFormat)) {
			lToken = JSONProcessor.packetToToken(aDataPacket);
		} else if (CommonConstants.WS_FORMAT_CSV.equals(aFormat)) {
			lToken = CSVProcessor.packetToToken(aDataPacket);
		} else if (CommonConstants.WS_FORMAT_XML.equals(aFormat)) {
