 ...
 * @author aschulze
 * @version $Id: WebSocketHandshake.java,v 1.3 2011/12/15 06:30:18 bleujin Exp $
 */
	...
	public static Map parseC2SRequest(byte[] aReq, boolean aIsSSL) {
		...
		if (lVersion == null) {
			if (lSecKey1 != null && lSecKey2 != null) {
				...
				lVersion = CommonConstants.WS_LATEST_SUPPORTED_HIXIE_VERSION;
				lDraft = CommonConstants.WS_LATEST_SUPPORTED_HIXIE_DRAFT;
			} else {
				lVersion = CommonConstants.WS_EARLIEST_SUPPORTED_HIXIE_VERSION;
				lDraft = CommonConstants.WS_EARLIEST_SUPPORTED_HIXIE_DRAFT;
			}
		}
		if (lDraft != null) {
