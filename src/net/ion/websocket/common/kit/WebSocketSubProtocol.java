...
import net.ion.websocket.common.kit.WebSocketEncoding;
import net.ion.websocket.common.kit.WebSocketSubProtocol;
...
public class WebSocketSubProtocol {
	...
	public WebSocketSubProtocol(String aSubProt, WebSocketEncoding aEncoding) {
		...
		if (CommonConstants.WS_SUBPROT_JSON.equals(aSubProt)) {
			mNameSpace = CommonConstants.WS_SUBPROT_PREFIX;
			mFormat = CommonConstants.WS_FORMAT_JSON;
		} else if (CommonConstants.WS_SUBPROT_XML.equals(aSubProt)) {
			mNameSpace = CommonConstants.WS_SUBPROT_PREFIX;
			mFormat = CommonConstants.WS_FORMAT_XML;
		} else if (CommonConstants.WS_SUBPROT_CSV.equals(aSubProt)) {
			mNameSpace = CommonConstants.WS_SUBPROT_PREFIX;
			mFormat = CommonConstants.WS_FORMAT_CSV;
		} else if (CommonConstants.WS_SUBPROT_TEXT.equals(aSubProt)) {
			mNameSpace = CommonConstants.WS_SUBPROT_PREFIX;
			mFormat = CommonConstants.WS_FORMAT_TEXT;
		} else if (CommonConstants.WS_SUBPROT_BINARY.equals(aSubProt)) {
			mNameSpace = CommonConstants.WS_SUBPROT_PREFIX;
			mFormat = CommonConstants.WS_FORMAT_BINARY;
		}
	}
