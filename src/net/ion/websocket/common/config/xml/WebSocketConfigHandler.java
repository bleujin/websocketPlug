...
import net.ion.websocket.common.config.LoggingConfigHandler;
import net.ion.websocket.common.config.SocketConfig;
import net.ion.websocket.common.kit.WebSocketRuntimeException;

/**
 * Handler class that handles the <tt>jWebSocket.xml</tt> configuration. This class starts from the root and delegates the handler to specific config handler, to read the whole config file.
 * 
 * @author puran
 * @version $Id: WebSocketConfigHandler.java,v 1.2 2011/08/02 02:43:04 bleujin Exp $
 */
public class WebSocketConfigHandler implements ConfigHandler {
	 ...
	 * {@inheritDoc}
	 */
	public SocketConfig processConfig(XMLStreamReader streamReader) {
