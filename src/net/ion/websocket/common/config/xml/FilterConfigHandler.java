 ...
 * 
 * @author puran
 * @version $Id: FilterConfigHandler.java,v 1.2 2011/07/23 04:35:54 bleujin Exp $
 * 
 */
public class FilterConfigHandler implements ConfigHandler {
	 ...
	 */
	private List<String> getServers(XMLStreamReader streamReader) throws XMLStreamException {
		List<String> servers = new FastList<String>();
	 ...
	 */
	private Map<String, String> getSettings(XMLStreamReader aStreamReader) throws XMLStreamException {
