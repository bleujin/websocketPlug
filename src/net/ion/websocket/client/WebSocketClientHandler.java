...
/**
 * Handles socket communication for a connected WebSocket client Not intended for end-users. Please use {@link WebSocketClient} or {@link WebSocketCallback} for controlling your client.
 * 
...
public class WebSocketClientHandler extends SimpleChannelUpstreamHandler implements WebSocketClient {
	...
	public void channelConnected(ChannelHandlerContext ctx, ChannelStateEvent e) throws Exception {
		...
		request.addHeader(Names.CONTENT_LOCATION, path);
		request.addHeader(CommonConstants.XUSER_INFO, StringUtil.defaultString(url.getUserInfo(), "N/A"));
